...
# ftpsyncup - Given a target directory on an ftp server, makes sure that all new or modified files are 
# uploaded to the remote system.  Uses a timestamp file called .timestamp to keep track.
