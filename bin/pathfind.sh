...
PATH=/opt/local/bin:/sw/bin:/sw/sbin:/bin:/sbin:/usr/bin:/usr/local/bin:/usr/sbin:/Users/bender/bin:/opt/csw/bin:/opt/csw/sbin:/opt/csw/apache/bin:/opt/csw/nagios/bin:/u01/nagios/bin:/usr/local/libexec:/usr/local/nagios/bin:/usr/nagios/libexec:/usr/nagios/bin
